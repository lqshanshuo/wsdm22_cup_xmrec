...
def main():
    ...
    print(f'model_name is : {args.model_name}')
    ...
    train_dataloader = MetaMarket_DataLoader(train_tasksets, sample_batch_size=args.batch_size, shuffle=False, num_workers=0)
